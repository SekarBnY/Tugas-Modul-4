Program dimulai dengan inisialisasi daftar produk yang tersedia menggunakan fungsi `create_products()`, yang membuat objek produk dengan nama dan harga. Setelah itu, objek `ShoppingCart` dibuat untuk 
